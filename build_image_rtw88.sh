...
rm -rf ./rtw88/alt_rtl8821ce
mv ./rtw88 ./drivers/net/wireless/realtek/rtw88
cp ../../config/linux/rtw88_Kconfig ./drivers/net/wireless/realtek/rtw88/Kconfig
...
dd if=/dev/zero of=./alpine.img bs=1M count=1000
